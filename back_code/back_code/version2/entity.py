...
_NER_MODEL_PATH = os.path.join(os.path.dirname(os.path.abspath(__file__)), "chinese-medical-ner")

def extract_entities(sentences):
    tokenizer = BertTokenizerFast.from_pretrained(_NER_MODEL_PATH, local_files_only=True, trust_remote_code=False)
    model = AutoModelForTokenClassification.from_pretrained(_NER_MODEL_PATH, local_files_only=True, trust_remote_code=False)
